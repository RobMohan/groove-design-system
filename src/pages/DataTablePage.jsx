    ...
    <table className="w-full text-left border-collapse">
      ...
      <tbody className="text-sm">
        <tr className="border-b border-line">
          ...
          <td className="py-3 px-4 font-mono text-xs text-ink-muted">array</td>
...
export default function DataTablePage() {
  ...
  const customColumns = [
    ...
    },
    {
      ...
      sortable: true,
      render: (value) => (
        <span className="text-base text-ink-muted">{new Date(value).toLocaleDateString()}</span>
      )
    },
  ];
...
<DataTable columns={columns} data={data} />`} />
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-6">
            Enable sorting by adding <code className="bg-surface-muted px-2 py-1 rounded text-sm">sortable: true</code> to a column.
            Click a header's sort icon to cycle ascending → descending → unsorted. Add <code className="bg-surface-muted px-2 py-1 rounded text-sm">filterable: true</code> to
  ...
  { key: 'assignee', header: 'Assignee', sortable: true },
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-6">
            Use the <code className="bg-surface-muted px-2 py-1 rounded text-sm">render</code> function to customize how cell content is displayed.
    ...
    render: (_, row) => (
      <button className="text-primary font-semibold hover:underline">
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-6">
            Pagination is enabled by default. Control items per page with the <code className="bg-surface-muted px-2 py-1 rounded text-sm">itemsPerPage</code> prop,
            or disable it entirely with <code className="bg-surface-muted px-2 py-1 rounded text-sm">showPagination=&#123;false&#125;</code>.
          </p>
...
<DataTable columns={columns} data={data} showPagination={false} />`} />
        ...
        <section className="mb-12">
          ...
          <p className="text-ink-muted mb-6">
            Turn on the toolbar features with <code className="bg-surface-muted px-2 py-1 rounded text-sm">searchable</code> (global search across all columns),
            <code className="bg-surface-muted px-2 py-1 rounded text-sm">selectable</code> (row checkboxes with a select-all), and
            <code className="bg-surface-muted px-2 py-1 rounded text-sm">showColumnVisibility</code> (a menu to show/hide columns).
            Use <code className="bg-surface-muted px-2 py-1 rounded text-sm">onRowSelectionChange</code> to react to the current selection.
          </p>
          <div className="bg-surface-raised rounded-lg border border-line p-8 mb-4">
            <DataTable
...
/>`} />
        ...
        <section className="mb-12">
          ...
          <div className="bg-surface-raised rounded-lg border border-line overflow-hidden mb-8">
            <PropsTable />
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-surface-raised rounded-lg border border-line p-8">
            <div className="space-y-4 text-ink-muted">
              <div>
                <p className="font-semibold text-ink mb-2">Keep it scannable:</p>
              ...
              <div>
                <p className="font-semibold text-ink mb-2">Sorting and filtering:</p>
                <ul className="list-disc list-inside space-y-2 pl-4">
